...
export default function MainButton(props) {
  ...
  const buttonDefaultStyles = `py-3 px-6 mx-auto min-h-10 w-full flex justify-center items-center bg-primary_color rounded-[10px]
 ...
 disabled:opacity-50 disabled:box-shadow-none disabled:transform-none shadow-bx-1 ${
  ...
  return (
    <motion.button
      ...
      whileHover={{ scale: 1.01, boxShadow: "0px 5px 15px rgba(0,0,0,0.4)" }}
      onClick={onClick}
      type={type}
      disabled={disabled}
    >
