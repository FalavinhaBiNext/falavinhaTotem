...
const treinamentos = () => {
    ...
    const options = [
        { name: "CONHEÇA NOSSOS CURSOS", route: routes.cursos },
      ];

    const data = {
        titulo: "TREINAMENTOS",
        subtitulo: "NÚCLEO DE EDUCAÇÃO CORPORATIVA GRUPO FALAVINHA NEXT",
        texto: "O grupo Falavinha Next oferece treinamentos empresariais focados em capacitar equipes e desenvolver habilidades estratégicas, visando aumentar a eficiência e aprimorar processos dentro das empresas. Com uma abordagem prática e adaptada às necessidades do mercado, nossos treinamentos cobrem áreas essenciais para o crescimento sustentável e o aprimoramento profissional.",
    };

    const topicos = [
        { titulo: "PALESTRAS", texto: "Palestras empresariais focadas em desenvolvimento profissional e melhoria contínua.", icone: gifComunicacao },
        { titulo: "TREINAMENTOS EMPRESARIAS", texto: "Treinamentos empresariais personalizados para capacitar equipes e impulsionar resultados.", icone: gifVideo },
        { titulo: "CURSOS ONLINES E PRESENCIAIS", texto: "Cursos online e presenciais que combinam flexibilidade e imersão, garantindo aprendizado de alta qualidade adaptado às necessidades de cada profissional e empresa.", icone: gifComputer },
        { titulo: "MENTORIAS PROFISSIONAIS", texto: "Mentorias profissionais focadas no desenvolvimento de lideranças e no aprimoramento de habilidades estratégicas, proporcionando acompanhamento personalizado para o crescimento de cada profissional.", icone: gifEngajamento },
    ];
